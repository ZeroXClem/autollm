...
from autollm.utils.logging import \
    logger  # Import logger from autollm.utils.logging

# Lazy import to avoid dependency on GitPython
try:
    from git import (  # Import InvalidGitRepositoryError and Repo classes from git module
        InvalidGitRepositoryError, Repo)
except ImportError:
