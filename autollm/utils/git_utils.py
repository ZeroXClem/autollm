...
def clone_or_pull_repository(git_url: str, local_path: Path) -> None:
    ...
    Raises:
        Exception: If GitPython is not installed.
    """
    """
    Clone a Git repository or pull latest changes if it already exists.
    ...
    try:
        ...
        logger.error('GitPython is not installed. Please "pip install gitpython==3.1.37" to use this feature. Error: {}'.format(str(e)))
        raise
