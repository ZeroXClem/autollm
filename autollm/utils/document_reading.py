...
from autollm.utils.git_utils import clone_or_pull_repository, is_git_repo
from autollm.utils.logging import logger
from autollm.utils.document_reading import clone_or_pull_repository, read_files_as_documents
...
def read_github_repo_as_documents(
    ...
    try:
        ...
        clone_or_pull_repository(git_repo_url, temp_dir, required_exts)
        ...
        # Read and process the documents
        documents = read_files_as_documents(input_dir=str(docs_path), input_files=None, exclude_hidden=True, filename_as_id=True, recursive=True, required_exts=required_exts, show_progress=True, **kwargs)
