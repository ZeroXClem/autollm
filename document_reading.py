...
from autollm.utils.git_utils import clone_or_pull_repository  # Added import
...
def read_github_repo_as_documents(
    ...
    try:
        ...
        clone_or_pull_repository(git_repo_url, temp_dir)  # Call clone_or_pull_repository function
        ...
        logger.error(f"An error occurred while cloning or pulling the repository: {str(e)}")
        raise
    finally:
