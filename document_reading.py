...
from .webpage_reader import WebSiteReader
from .website_reader import SimpleDirectoryReader
...
def read_github_repo_as_documents(
    ...
    try:
        ...
        logger.error(f"Error occurred while cloning or pulling the repository: {e}")
        raise
    finally:
